...
class TestBuses(unittest.TestCase):
    ...
    def test_load_from_files(self):
        result = buses.load_from_files(os.path.dirname(os.getcwd())+'/buses_in_Warsaw_bd/data', 'data')
        ...
        self.assertRaises(ValueError, buses.load_from_files, os.path.dirname(os.getcwd())+'/buses_in_Warsaw_bd/data', 'bus_stops')

    def test_distance(self):
        dataset = buses.load_from_files(os.path.dirname(os.getcwd())+'/buses_in_Warsaw_bd/data', 'data')
    ...
    def test_load_bus_stops_from_file(self):
        result = buses.load_bus_stops_from_file(os.path.dirname(os.getcwd())+'/buses_in_Warsaw_bd/data', 'bus_stops_0.txt')
    ...
    def test_load_schedule_from_file(self):
        result = buses.load_schedule_from_file(os.path.dirname(os.getcwd()) + '/buses_in_Warsaw_bd/data', 'schedule_7009_01_523_0.txt')
        self.assertIsNotNone(result)
    ...
    def test_is_on_time(self):
        dataset = buses.load_from_files(os.path.dirname(os.getcwd()) + '/buses_in_Warsaw_bd/data', 'data')
        locations_dataset = buses.load_bus_stops_from_file(os.path.dirname(os.getcwd()) + '/buses_in_Warsaw_bd/data', "bus_stops_0.txt")
